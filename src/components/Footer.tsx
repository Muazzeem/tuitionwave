        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="md:col-span-2">
            <div className="mb-6 flex items-center">
              ...
              <span className="text-2xl font-bold text-blue-400">Tuitionwave</span>
            </div>
          ...
          <div>
            <h3 className="font-medium mb-4 text-gray-200">Short links</h3>
            <ul className="space-y-2">
              <li><Link to="/how-it-works" className="text-gray-400 hover:text-blue-400">How it works</Link></li>
            </ul>
          </div>

          <div>
            <h3 className="font-medium mb-4 text-gray-200">Other pages</h3>
            <ul className="space-y-2">
              <li><Link to="/terms" className="text-gray-400 hover:text-primary-600 dark:hover:text-blue-400">Terms & conditions</Link></li>
              <li><Link to="/faq" className="text-gray-400 hover:text-blue-400">FAQ</Link></li>
            </ul>
          </div>
        </div>

        <div className="border-0 pt-8 flex flex-col md:flex-row justify-between items-center">
