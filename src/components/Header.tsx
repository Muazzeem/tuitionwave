      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            {userProfile ? (
              <button
                className="bg-blue-600 text-white rounded-full px-6 py-2 text-sm transition-colors shadow-lg hover:shadow-xl hover:bg-blue-700 transition-all duration-300 transform hover:scale-[1.02]"
