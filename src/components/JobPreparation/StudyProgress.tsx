      ...
      <CardContent>
        {loading ? (
          ...
          <div className="text-center py-12">
            <div className="bg-gradient-to-br from-emerald-50 to-green-50 dark:from-emerald-900/20 dark:to-green-900/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                ...
                {subjects.map((subject, index) => {
                  ...
                  return (
                    <div
                      ...
                      className={`p-4 rounded-lg border transition-all hover:shadow-sm ${isCompleted
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex justify-between items-center text-xs">
                          <span className={`font-medium ${isCompleted ? 'text-green-700 dark:text-green-300' :
                            isHighProgress ? 'text-blue-700 dark:text-blue-300' :
                              isMediumProgress ? 'text-yellow-700 dark:text-yellow-300' :
