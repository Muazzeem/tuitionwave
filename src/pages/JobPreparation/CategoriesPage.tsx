...
import { BookOpen, Search, Grid3X3, List, Filter, Star, TrendingUp, ChevronRight, Users, Target, ChevronLeft } from 'lucide-react';
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
      {filteredCategories.map((category) => {
        ...
        return (
          <Card
            key={category.uid}
            className="group cursor-pointer hover:shadow-xl transition-all duration-300 hover:border-primary
