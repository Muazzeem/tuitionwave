            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4 mb-8">
              ...
              <Card className="dark:bg-gray-800 dark:border-gray-700">
                <CardContent className="p-4 text-center">
                  ...
                  <div className="text-2xl font-bold text-foreground">{platformStats.successfulMatches.toLocaleString()}</div>
              ...
              <Card className="dark:bg-gray-800 dark:border-gray-700">
                <CardContent className="p-4 text-center">
                  ...
                  <div className="text-2xl font-bold text-foreground">{platformStats.averageRating}</div>
              ...
              <Card className="dark:bg-gray-800 dark:border-gray-700">
                <CardContent className="p-4 text-center">
                  ...
                  <div className="text-2xl font-bold text-foreground">{platformStats.monthlyGrowth}%</div>
